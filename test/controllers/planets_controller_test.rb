...
class PlanetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planet" do
    assert_difference('Planet.count') do
      post planets_url, params: { planet: { climate: @planet.climate, name: @planet.name, terrain: @planet.terrain } }
    end
  ...
  test "should update planet" do
    patch planet_url(@planet), params: { planet: { climate: @planet.climate, name: @planet.name, terrain: @planet.terrain } }
